...
export default class BasicDemo extends React.Component<any, any> {
  ...
  renderSectionHeader = (sectionData) => {
    return (
      <Text style={[{ textAlign:'right', padding: 10, backgroundColor: 'rgba(255,255,255,0.8)' }]}>
  ...
  render() {
      ...
      return (<View key={rowID}>
        ...
        >
          <View>
            ...
            >
              <Text style={{ textAlign:'right', fontSize: 18, fontWeight: '500', padding: 2 }}>{obj.title}</Text>
            </View>
            <View style={[{ flexDirection: 'row-reverse' }]}>
              <Image style={[{ height: 64, width: 64, marginLeft: 8 }]} source={{ uri: obj.img }} />
              <View>
    ...
    return (
      <ListView
        ...
        renderHeader={() => <Text style={[{ textAlign: 'right', padding: 8 }]}>列表头</Text>}
